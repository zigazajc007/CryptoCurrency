...
public class CreateSignShopListener implements Listener {
	...
	public void onSignChange(SignChangeEvent event) {
		...
		for (String crypto : Settings.cryptos.keySet())
			if (line4.toUpperCase().contains(crypto.toUpperCase())) currency = crypto;
		...
		for (String li3 : lin3)
			sb.append(Character.toUpperCase(li3.charAt(0))).append(li3.toLowerCase().substring(1)).append(" ");
