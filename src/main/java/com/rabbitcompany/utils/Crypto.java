...
public class Crypto {
	...
	public Crypto(String fullName, String name, String color, String format, double maximum, double minimum, double max_supply, double max_per_player, double price_multiplier) {
